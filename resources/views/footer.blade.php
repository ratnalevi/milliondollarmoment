            ...
            <div class="col-md-6 col-sm-12">
                <div class="contact-info">
                    ...
                    <div class="single">
                        ...
                        <p>Hno: 61/3, Phase 4, KPHB Colony,<br>
                    ...
                    <div class="single">
                        ...
                        <p>antipas.g@gmail.com</p>
                    </div>

                    <div class="social-icon">
                        <ul class="list-inline">
                            <li><a href="https://www.facebook.com/themilliondollarmoment/" target="_blank" title=""><i class="fa fa-facebook"></i></a></li>
